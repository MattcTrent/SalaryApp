...
export const SalaryRow = (props: DataRowProps) => {
  ...
  return (
    <TableRow className={styles.row}>
      <TableCell align="left" className={styles.titleCell}>{props.rowName}</TableCell>
      {props.showColumn === Showcolumn.YEARLY ? <TableCell align="left">
        {NumberHelper.ToCurrencyString(yearlyValue)}
      </TableCell> : null}
      {props.showColumn === Showcolumn.MONTHLY ? <TableCell align="left">
        {NumberHelper.ToCurrencyString(props.rowValue)}
      </TableCell> : null}
      {props.showColumn === Showcolumn.WEEKLY ? <TableCell align="left">
        {NumberHelper.ToCurrencyString(weeklyValue)}
      </TableCell> : null}
      {props.showColumn === Showcolumn.DAILY ? <TableCell align="left">
        {NumberHelper.ToCurrencyString(dailyValue)}
      </TableCell> : null}
      {props.showColumn === Showcolumn.Hourly ? <TableCell align="left">
